	...
	<form id="add-form" method="post">
        <table>
            <tr>
                ...
                <!-- ../../resources/admin/easyui/images/user_photo.jpg中../../代表/admin/user跑到向上两层的根目录 -->
                <td valign="middle">
            ...
            <tr>
                ...
                <td>
                    <select name="roleId" class="easyui-combobox" panelHeight="auto" style="width: 268px" data-options="required:true, missingMessage:'请选择角色'">
                        <!-- roleList对应UserController中的 model.addObject("roleList", roleService.findList(queryMap)); 中的roleList -->
                        <c:forEach items="${roleList}" var="role">
                            <option value="${role.id}">${role.name}</option>
                        </c:forEach>
                    </select>
...
<script type="text/javascript">
	...
	*/
	$('#data-datagrid').datagrid({
        <!-- list对应于UserController中@RequestMapping(value = "/list", method = RequestMethod.POST)中的list -->
        url:'list',
		<!-- 去掉之后刷新功能才有效 -->
