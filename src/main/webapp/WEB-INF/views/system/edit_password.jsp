...
<title>后台管理主页</title>
<!-- 一个../向上跳转一层，即跳转到system这一层，如果是../../则向上跳转两层，即跳转到admin/system的admin这一层 -->
	...
	<form id="edit-form" method="post">
        <table>
            ...
            <tr>
                ...
                <!-- id="oldPassword"中oldPassword对应于本页面data:{oldPassword:$("#oldPassword").val(),newPassword:$("#newPassword").val()},中的$("#oldPassword")中的oldPassword -->
            ...
            <tr>
                ...
                <!-- id="newPassword"中newPassword对应于本页面data:{oldPassword:$("#oldPassword").val(),newPassword:$("#newPassword").val()},中的$("#newPassword")中的newPassword -->
...
function submitEdit() {
    ...
    $.ajax({
        <!-- edit_password对应于SystemController中@RequestMapping(value = "/edit_password", method = RequestMethod.POST)中的edit_password -->
        url:'edit_password',
        type:'post',
        // oldPassword:$("#oldPassword").val()，前一个oldPassword对应SystemController中
        // public Map<String, String> editPasswordAct(String newPassword, String oldPassword, HttpServletRequest request)中的oldPassword
        // 后一个oldPassword对应该页面上<td><input type="password" id="oldPassword"中的oldPassword
        data:{oldPassword:$("#oldPassword").val(),newPassword:$("#newPassword").val()},
        dataType:'json',
        success:function(data) {
            if (data.type == 'success') {
                $.messager.alert("消息提醒","密码修改成功！","info");
            } else {
