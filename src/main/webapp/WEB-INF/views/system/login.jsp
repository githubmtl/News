...
<div id="particles-js">
    <div class="login" style="display: block;">
        ...
        <div class="login-center clearfix">
            <%-- login.jsp在system/下，所在目录对应SystemController中system/下，../跳转到system/上一级目录：根目录 --%>
...
<script type="text/javascript">
    ...
    document.querySelector(".login-button").onclick = function(){
        // jquery获取输入框中用户名，id=username，因此写$("#username")
        // jquery获取输入框中密码，id=password，因此写$("#password")
        // jquery获取输入框中验证码，id=cpacha，因此写$("#cpacha")
