...
<div id="loading" style="position:absolute;z-index:1000;top:0px;left:0px;width:100%;height:100%;background:#FFFFFF;text-align :center;padding-top:6%;">
    ...
    <%--<h1><span style="color: grey; ">加载中...</span></h1>--%>
</div>
<!-- begin of header -->
<div class="wu-header" data-options="region:'north',border:false,split:true">
    ...
    <div class="wu-header-right">
        ...
        <%--target="_blank"意思是 在新窗口打开链接--%>
        <p>
            <a href="../index/index" target="_blank">网站首页</a>|
            <a href="https://bbs.csdn.net/" target="_blank">CSDN论坛</a>|
            <a href="https://www.zhihu.com/" target="_blank">知乎首页</a>|
...
<div class="wu-sidebar" data-options="region:'west',split:true,border:true,title:'导航菜单'">
    <div class="easyui-accordion" data-options="border:false,fit:true">
        <!-- topMenuList对应SystemController中model.addObject("topMenuList", MenuUtil.getAllTopMenu(userMenus));中的topMenuList -->
...
<div class="wu-footer" data-options="region:'south',border:true,split:true">
    &copy; 2020 【HaoHu】 All Rights Reserved
</div>
<!-- end of footer -->
