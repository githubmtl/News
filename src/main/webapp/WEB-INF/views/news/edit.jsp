        ...
        <form id="edit-form" method="post">
            ...
            <table cellpadding="5">
                ...
                <tr>
                    <td>新闻内容:</td>
                    <td>
                        <textarea id="edit-content" name="content" rows="6" style="width: 760px; height: 300px;">${news.content }</textarea>
                    </td>
                </tr>
            </table>
        </form>
...
<div id="preview-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:530px; padding:10px;">
    <table>
        <tr>
            ...
            <td><img id="preview-photo" src="${news.photo }" width="500" height="500"></td>
        </tr>
    </table>
</div>
<!-- 上传图片进度条 -->
