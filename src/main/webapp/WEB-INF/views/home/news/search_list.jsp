...
<section class="container">
    <div class="content-wrap">
        <div class="content" id="news-list">
            ...
            <div class="title">
                <!--keyword对应HomeNewsController中searchList方法中model.addObject("keyword", keyword);中的"keyword"-->
                <h3>关键字：${keyword }</h3>
            </div>
            <%--newsList对应HomeNewsController中searchList方法中model.addObject("newsList", newsService.findList(queryMap));中的"newsList"--%>
...
$(document).ready(function() {
    $("#load-more-btn").click(function () {
        ...
        $.ajax({
            ...
            data:{page:page++,rows:10,keyword:'${keyword }'},
            dataType:'json',
            success:function(data) {
                if (data.type == 'success'){
                    $("#load-more-btn").text('查看更多');
                    // data.newsList;中newsList对应HomeNewsController中getSearchList方法中ret.put("newsList", newsService.findList(queryMap));中的"newsList"
