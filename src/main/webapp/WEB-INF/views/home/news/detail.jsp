        ...
        <div class="content">
            <header class="article-header">
                ...
                <div class="article-meta">
                    ...
                    <span class="item article-meta-source" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="来源：【HH】">
                        <i class="glyphicon glyphicon-globe"></i>HH新闻
                    </span>
                    ...
                    <div class="comment">
                        ...
                        <div class="comment-box">
                            ...
                            <div class="comment-ctrl">
                                ...
                                <button type="button" id="comment-submit" name="comment-submit" tabindex="4">评论</button>
                            </div>
                        </div>
                    </div>
                </form>
...
<script>
/*当前页，从第1页开始，对应下面data:{page:page++,rows:10},中的前一个page*/
var page = 1;
/*整个页面加载完成后再运行*/
$(document).ready(function() {
    ...
    $("#comment-submit").click(function () {
        ...
        $.ajax({
            <!-- get_search_list对应HomeNewsController中getSearchList方法中@RequestMapping(value = "/get_search_list",method = RequestMethod.POST)中的get_search_list -->
            url:'../news/comment_news',
            type:'post',
            // page对应上面定义的变量var page = 1; rows对应page/admin/Page中的rows，即每页显示的条数，即点击查看更多10条10条的显示
            data:$("#comment-form").serialize(),
            dataType:'json',
            success:function(data) {
                if (data.type == 'success'){
                    var li = '<li class="comment-content"><span class="comment-f">#' + ($("#comment_list").children('li').length + 1);
                    // format(data.createTime)中的createTime对应HomeNewsController中commentNews方法中ret.put("createTime", comment.getCreateTime());中的"createTime"
    ...
    $.ajax({
        ...
        type:'post',
        data:{page:page++,rows:10,newsId:'${news.id }'},
        dataType:'json',
        success:function(data) {
            if (data.type == 'success'){
                // data.commentList;中commentList对应HomeNewsController中getCommentList方法中ret.put("commentList", commentService.findList(queryMap));中的"commentList"
