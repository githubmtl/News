...
public class CommentController {
    ...
    public Map<String, Object> getList(
        ...
        Map<String, Object> queryMap = new HashMap<String, Object>();
        // 前面的nickname对应CommentMapper中<select id="findList" parameterType="Map" resultMap="commentMap">
        // <if test="nickname != null"> and c.nickname like '%${nickname}%'</if>中'%${nickname}%'中的nickname
        // 后面的nickname为@RequestParam中 String nickname中的nickname
